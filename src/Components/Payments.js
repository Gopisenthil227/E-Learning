...
const Payment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) { // Ensure successful status code
        setSuccessMessage('Payment details successfully added!');
        setErrorMessage('');
      } else {
        throw new Error('Payment failed'); // Handle non-200 status codes
      }
    } catch (error) {
  ...
  return (
    <div className="pay-container">
      <div className="left-side">
        <img src="https://static.vecteezy.com/system/resources/thumbnails/017/334/390/small_2x/successful-payment-businessman-through-smart-phones-with-modern-technology-wallet-app-banking-and-online-shopping-wireless-financial-transactions-shopping-service-on-the-online-web-consumer-society-photo.jpg" alt="Left Side" style={{ width: '120vh', height: '90vh' }} />
      </div>
